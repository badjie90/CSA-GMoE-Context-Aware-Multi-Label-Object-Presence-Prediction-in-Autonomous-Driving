...
# path: bdd100k_moe.py
"""
BDD100K Condition-Specialized MoE Training Script
...
def create_dataloaders(
    ...
    test_ds = BDD100KPresenceDataset(test_rows, eval_transform)
...
#     prepare_parser.add_argument("--data-root", type=str, required=True)
#     prepare_parser.add_argument("--det-train-json", type=str, required=True)
#     prepare_parser.add_argument("--det-val-json", type=str, required=True)
#     prepare_parser.add_argument("--output-dir", type=str, required=True)
...
#     train_parser.add_argument("--data-root", type=str, required=False, default="")
#     train_parser.add_argument("--metadata-dir", type=str, required=True)
#     train_parser.add_argument("--experiment-dir", type=str, required=True)
...
# path: /home/bbadjie/SEAS-GMoE_Extension/AAutonomous/scripts/bdd100k_moe.py
...
DEFAULT_OUTPUT_DIR = "/home/bbadjie/SEAS-GMoE_Extension/AAutonomous/data/metadata_files/metadata"
DEFAULT_EXPERIMENT_DIR = "experiments/moe_stage3"
    ...
    if len(sys.argv) == 1:
        ...
        if not metadata_bundle.exists():
            raise SystemExit(
                ...
                "Run this first:\n"
                "python /home/bbadjie/SEAS-GMoE_Extension/AAutonomous/scripts/bdd100k_moe.py prepare"
            )
